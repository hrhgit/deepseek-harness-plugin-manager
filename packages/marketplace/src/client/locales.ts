export const zh = {
  ...
  notInstallable: '暂不可安装', candidateStatus: '待适配', candidateInstallable: '可安装候选', candidateInstallWarning: '未提供合法 DSH 清单，请先确认兼容性', admissionReason: '未通过安装准入', unknown: '未声明', status: '状态',
...
export const en: Record<LocaleKey, string> = {
  ...
  notInstallable: 'Not installable', candidateStatus: 'Needs adaptation', candidateInstallable: 'Installable candidate', candidateInstallWarning: 'No valid DSH manifest was found; confirm compatibility before installing', admissionReason: 'Installation admission failed', unknown: 'Not declared', status: 'Status',
